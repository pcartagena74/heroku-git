...
use App\Notifications\TicketItNotification;
...
class NotificationsControllerOver extends Controller
{
    ...
    public function sendNotification($template, $data, $ticket, $notification_owner, $subject, $type)
    {
        ...
        Notification::route('mail', $to->email)
            ->notify(new TicketItNotification($to, $notification_owner, $template, $data, $subject, $type));
