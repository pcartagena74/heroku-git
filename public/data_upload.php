                    ...
                    case 'evtdata':
                        ...
                        if ($row == 1) {
                            ...
                            for ($i = 1; $i < $num; $i++) {  // skipping 0 because it's 'Attended'
                                switch (true) {
                                    case preg_match('/salutation/i', $data[$i]):
                                        $map[2] = $i;
                                        debug(8, "map2: $i; sal<br>");
                                        break;
                                    case preg_match('/^first name$/i', $data[$i]):
                                        $map[3] = $i;
                                        debug(8, "map3: $i; fn<br>");
                                        break;
                                    case preg_match('/last name/i', $data[$i]):
                                        $map[4] = $i;
                                        debug(8, "map4: $i; ln<br>");
                                        break;
                                    case preg_match('/suffix/i', $data[$i]):
                                        $map[5] = $i;
                                        debug(8, "map5: $i; sfx<br>");
                                        break;
                                    case preg_match('/email/i', $data[$i]):
                                        $map[6] = $i;
                                        debug(8, "map6: $i; em1<br>");
                                        break;
                                    case preg_match('/^ticket$/i', $data[$i]):
                                        $map[7] = $i;
                                        debug(8, "map7: $i; tkt<br>");
                                        break;
                                    case preg_match('/seat/i', $data[$i]):
                                        $map[8] = $i;
                                        debug(8, "map8: $i; st<br>");
                                        break;
                                    case preg_match('/registered on/i', $data[$i]):
                                        $map[9] = $i;
                                        debug(8, "map9: $i; reg<br>");
                                        break;
                                    case preg_match('/registered by/i', $data[$i]):
                                        $map[10] = $i;
                                        debug(8, "map10: $i; rby<br>");
                                        break;
                                    case preg_match('/^payment$/i', $data[$i]):
                                        $map[11] = $i;
                                        debug(8, "map11: $i; pay<br>");
                                        break;
                                    case preg_match('/confirmation co/i', $data[$i]):
                                        $map[12] = $i;
                                        debug(8, "map12: $i; cfm<br>");
                                        break;
                                    case preg_match('/payment rec/i', $data[$i]):
                                        $map[13] = $i;
                                        debug(8, "map13: $i; pyr<br>");
                                        break;
                                    case preg_match('/^status$/i', $data[$i]):
                                        $map[14] = $i;
                                        debug(8, "map14: $i; stat<br>");
                                        break;
                                    case preg_match('/cancelled on/i', $data[$i]):
                                        $map[15] = $i;
                                        debug(8, "map15: $i; canc<br>");
                                        break;
                                    case preg_match('/^cost$/i', $data[$i]):
                                        $map[16] = $i;
                                        debug(8, "map16: $i; cost<br>");
                                        break;
                                    case preg_match('/cc charge/i', $data[$i]):
                                        $map[17] = $i;
                                        debug(8, "map17: $i; ccc<br>");
                                        break;
                                    case preg_match('/handling/i', $data[$i]):
                                        $map[18] = $i;
                                        debug(8, "map18: $i; hnd<br>");
                                        break;
                                    case preg_match('/your amount/i', $data[$i]):
                                        $map[19] = $i;
                                        debug(8, "map19: $i; amt<br>");
                                        break;
                                    case preg_match('/disc code/i', $data[$i]):
                                        $map[20] = $i;
                                        debug(8, "map20: $i; dcc<br>");
                                        break;
                                    case preg_match('/disc desc/i', $data[$i]):
                                        $map[21] = $i;
                                        debug(8, "map21: $i; dd<br>");
                                        break;
                                    case preg_match('/disc amount/i', $data[$i]):
                                        $map[22] = $i;
                                        debug(8, "map22: $i; damt<br>");
                                        break;
                                    case preg_match('/pmi (number|membership)/i', $data[$i]):
                                        $map[23] = $i;
                                        debug(8, "map23 $i; pmi<br>");
                                        break;
                                    case preg_match('/preferred first/i', $data[$i]):
                                        $map[24] = $i;
                                        debug(8, "map24: $i; pfn<br>");
                                        break;
                                    case preg_match('/topic/i', $data[$i]):
                                        $map[25] = $i;
                                        debug(8, "map25: $i; top<br>");
                                        break;
                                    case preg_match("/pmp\?/i", $data[$i]):
                                        $map[26] = $i;
                                        debug(8, "map26: $i; pmp<br>");
                                        break;
                                    case preg_match('/first time/i', $data[$i]):
                                        $map[27] = $i;
                                        debug(8, "map27: $i; ft<br>");
                                        break;
                                    case preg_match('/city and state/i', $data[$i]):
                                        $map[28] = $i;
                                        debug(8, "map28: $i; cst<br>");
                                        break;
                                    case preg_match("/company name\?/i", $data[$i]):
                                        $map[29] = $i;
                                        debug(8, "map29: $i; comp<br>");
                                        break;
                                    case preg_match('/authorize/i', $data[$i]):
                                        $map[30] = $i;
                                        debug(8, "map30: $i; auth<br>");
                                        break;
                                    case preg_match('/question(s)*/i', $data[$i]):
                                        $map[31] = $i;
                                        debug(8, "map31: $i; que<br>");
                                        break;
                                    case preg_match('/(allergy)|(dietary)/i', $data[$i]):
                                        $map[32] = $i;
                                        debug(8, "map32: $i; food<br>");
                                        break;
                                    case preg_match('/industry/i', $data[$i]):
                                        $map[33] = $i;
                                        debug(8, "map33: $i; ind<br>");
                                        break;
                                    case preg_match('/(networking list)|(networking handout)/i', $data[$i]):
                                        $map[34] = $i;
                                        debug(8, "map34: $i; net<br>");
                                        break;
                                    default:
                                        echo "Encountered an unknown column: '" . $data[$i] . "'<br>";
                                        break;
                                } // switch
                            } // for
                            print_r($map);
