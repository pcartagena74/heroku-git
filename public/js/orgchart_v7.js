var OrgChart = function (t, e) {
    var r = this;
    if (this.element = t, this.config = OrgChart._defaultConfig(), e) for (var i in this.config) "object" != typeof e[i] || Array.isArray(e[i]) ? void 0 !== e[i] && (this.config[i] = e[i]) : this.config[i] = OrgChart._mergeObject(this.config[i], e[i]);
...
OrgChart._defaultConfig = function () {
    ...
    this.manager.read(t, this.width(), this.height(), e, m, O, function (t) {
        ...
        for (o = 0; o < t.visibleNodeIds.length; o++) {
            ...
            r += x.ui.link(l, x, i, t.bordersByRootIdAndLevel, t.nodes, m), r += x.ui.expandCollapseBtn(x, l, x._layoutConfigs, m, i)
        }
        e = {content: r, res: t};
        if (OrgChart.events.publish("render", [x, e]), r = e.content, t = e.res, r += x.ui.lonely(x.config), m !== OrgChart.action.exporting) {
            m !== OrgChart.action.centerNode && m !== OrgChart.action.insert && m !== OrgChart.action.expand && m !== OrgChart.action.collapse && m !== OrgChart.action.update || (n = a), m === OrgChart.action.init && null != a && (n = a), x.response = t;
            C = x.ui.svg(x.width(), x.height(), n, x.config, r);
            if (x._initialized) {
                var h = x.getSvg(), d = h.parentNode;
                d.removeChild(h), d.insertAdjacentHTML("afterbegin", C), x._attachEventHandlers(), x.xScrollUI.addListener(x.getSvg()), x.yScrollUI.addListener(x.getSvg()), x.xScrollUI.setPosition(), x.yScrollUI.setPosition()
            ...
            m === OrgChart.action.centerNode ? OrgChart.anim(x.getSvg(), {viewbox: a}, {viewbox: x.response.viewBox}, x.config.anim.duration, x.config.anim.func, function () {
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            var h = i.w, d = i.h, c = o < h - o ? h - o : o, g = l < d - l ? d - l : l, p = (g = g) < (c = c) ? c : g,
                ...
                m = document.createElementNS("http://www.w3.org/2000/svg", "circle"), O = OrgChart.randomId();
            u.setAttribute("id", O);
            var y = {ripple: OrgChart.t(i.templateName, i.min, this.getScale()).ripple, node: i};
            OrgChart.events.publish("ripple", [this, y]), C.setAttribute("x", y.ripple.rect ? y.ripple.rect.x : 0), C.setAttribute("y", y.ripple.rect ? y.ripple.rect.y : 0), C.setAttribute("width", y.ripple.rect ? y.ripple.rect.width : i.w), C.setAttribute("height", y.ripple.rect ? y.ripple.rect.height : i.h), C.setAttribute("rx", y.ripple.radius), C.setAttribute("ry", y.ripple.radius), m.setAttribute("clip-path", "url(#" + O + ")"), m.setAttribute("cx", o), m.setAttribute("cy", l), m.setAttribute("r", 0), m.setAttribute("fill", y.ripple.color), m.setAttribute("class", "ripple"), u.appendChild(C), f.appendChild(u), f.appendChild(m), a.appendChild(f), OrgChart.anim(m, {
                r: 0,
                opacity: 1
    ...
    return Array.isArray(c) || (c = [c]), Array.isArray(g) || (g = [g]), Array.isArray(p) || (p = [p]), O = setInterval(function () {
        for (var t = 0; t < c.length; t++) for (var e in p[t]) {
            ...
            switch (e.toLowerCase()) {
                ...
                case"r":
                    ...
                    break;
                case"x1":
                    n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e], c[t].setAttribute("x1", n);
                    break;
                case"x2":
                    n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e], c[t].setAttribute("x2", n);
                    break;
                case"y1":
                    n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e], c[t].setAttribute("y1", n);
                    break;
                case"y2":
                    n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e], c[t].setAttribute("y2", n);
                    break;
                case"rotate3d":
                    if (p[t][e]) {
    ...
    if (d.innerHTML = "Upload", d.style.position = "absolute", d.style.right = 0, o.style.margin = "14px 14px 7px 14px", o.style.textAlign = "left", o.style.position = "relative", o.setAttribute(OrgChart.attr.field_name, t), h.style.border = "1px solid #d7d7d7", h.style.backgroundColor = "#d7d7d7", h.style.display = "block", h.style.width = "100%", l.style.color = "#bcbcbc", s.style.border = "none", s.style.outline = "none", s.style.width = "100%", s.setAttribute(OrgChart.attr.val, ""), a && (s.style.width = "80%"), s.style.fontSize = "16px", s.readOnly = i, null != e && null != e && (s.value = e), null != r && null != r && (s.placeholder = r), null != t && null != t && (l.innerHTML = t), l.setAttribute(OrgChart.attr.lbl, ""), s.style.color = "#7a7a7a", i || s.addEventListener("focus", function () {
    ...
    if (this.wrapperElement) {
        ...
        if (t) {
            for (var r = this.wrapperElement.querySelectorAll("[" + OrgChart.attr.field_name + "]"), i = 0; i < r.length; i++) {
                var a = r[i].getAttribute(OrgChart.attr.field_name);
                if (a) {
                    var n = r[i].querySelector("[" + OrgChart.attr.val + "]");
                    if (n) {
                        var o = n.value;
                        if (a === OrgChart.TAGS) e.tags = o.split(","); else if ("isAssistant" === a) {
                            var l = r[i].querySelector("[" + OrgChart.attr.val + "]").checked;
                            l && e.tags ? OrgChart._arrayContains(this.node.tags, "assistant") || (OrgChart.STRING_TAGS ? e.tags += ",assistant" : e.tags.push("assistant")) : l && !e.tags ? OrgChart.STRING_TAGS ? e.tags = "assistant" : e.tags = ["assistant"] : !l && e.tags && -1 != this.node.tags.indexOf("assistant") && e.tags.splice(e.tags.indexOf("assistant"), 1)
                        } else null != e[a] ? e[a] = o : "" != o && (e[a] = o)
                    }
                }
            }
            var s = this;
            this.obj._hideBeforeAnimation(), OrgChart.anim(s.wrapperElement, {right: 0, opacity: 1}, {
                right: -150,
                opacity: 0
            }, 300, OrgChart.anim.inOutSin, function () {
                s.obj._showAfterAnimation(), s.obj.updateNode(e, null, !0), s.obj.element.removeChild(s.wrapperElement), s.wrapperElement = null
            })
    ...
    for (var a in l = i.menu) {
        ...
        void 0 === h && (h = OrgChart.icon[a](24, 24, "#7A7A7A")), "function" == typeof d && (d = d()), "function" == typeof h && (h = h()), r += "<div " + OrgChart.attr.item + '="' + a + '" style="border-bottom: 1px solid #D7D7D7; padding: 7px 10px;color: #7A7A7A;">' + h + "<span>&nbsp;&nbsp;" + d + "</span></div>"
    }
    if ("" != r) {
        ...
        for (var f = this.wrapper.getElementsByTagName("div"), u = 0; u < f.length; u++) {
            (a = f[u]).addEventListener("mouseover", function () {
                ...
                var e, r = this.getAttribute(OrgChart.attr.item);
    ...
    var i = this, r = this.obj.getNode(t), a = OrgChart.t(r.templateName, r.min, this.obj.getScale());
    if (!OrgChart.isNullOrEmpty(a.nodeCircleMenuButton)) {
        ...
        if (OrgChart.isNullOrEmpty(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
            this.hide(), e || (e = this.menu);
            var f = {nodeId: t, menu: e}, u = OrgChart.events.publish("show", [this, f]);
            if (this._menu = e, !1 === u) return !1;
            for (var C = 0, m = Object.keys(f.menu).length, O = 2 * a.nodeCircleMenuButton.radius + 4, y = 2 * Math.PI * O, x = y / m - (2 * a.nodeCircleMenuButton.radius + 2); x < 0;) O += 8, x = (y = 2 * Math.PI * O) / m - (2 * a.nodeCircleMenuButton.radius + 2);
            for (var v in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t), p.setAttribute("transform", "matrix(1,0,0,1," + d + "," + c + ")"), n.appendChild(p), f.menu) {
                var b = f.menu[v].icon, _ = f.menu[v].color, w = f.menu[v].text;
                "function" == typeof b && (b = b()), "function" == typeof _ && (_ = _()), "function" == typeof w && (w = w());
                var k = document.createElementNS("http://www.w3.org/2000/svg", "g");
                k.setAttribute("transform", "matrix(1,0,0,1,0,0)"), k.setAttribute(OrgChart.attr.control_node_circle_menu_name, v), k.style.cursor = "pointer";
                ...
                I.setAttribute("cx", 0), I.setAttribute("cy", 0), I.setAttribute("r", a.nodeCircleMenuButton.radius), I.setAttribute("fill", _), I.setAttribute("stroke-width", "1"), I.setAttribute("stroke", a.nodeCircleMenuButton.stroke), k.appendChild(I), k.appendChild(S), k.innerHTML += b, p.appendChild(k);
                var A = k.getElementsByTagName("svg")[0];
                if (A.setAttribute("pointer-events", "none"), A) {
                    var E = parseInt(A.getAttribute("width")), M = parseInt(A.getAttribute("height"));
                    A.setAttribute("x", -E / 2), A.setAttribute("y", -M / 2)
                }
                var N = C * Math.PI / (m / 2);
                C++;
                var L = Math.cos(N) * O, T = Math.sin(N) * O;
                this._buttonsInterval.push(OrgChart.anim(k, {transform: [1, 0, 0, 1, 0, 0]}, {transform: [1, 0, 0, 1, L, T]}, 250, OrgChart.anim.outBack, function (t) {
                    ...
                    t[0].addEventListener("mouseenter", function (t) {
                        OrgChart.events.publish("mouseenter", [i, {
                            from: r,
                            menuItem: f.menu[e],
                            menuItemName: e,
                            event: t
                        ...
                        OrgChart.events.publish("mouseout", [i, {
                            from: r,
                            menuItem: f.menu[e],
                            menuItemName: e,
                            event: t
    ...
    for (var t = this._buttonsInterval.length - 1; 0 <= t; t--) clearInterval(this._buttonsInterval[t]), this._buttonsInterval.splice(t, 1);
    this._buttonsInterval = [];
    for (t = this._linesInterval.length - 1; 0 <= t; t--) clearInterval(this._linesInterval[t]), this._linesInterval.splice(t, 1);
    this._linesInterval = [];
    ...
    t.setAttribute("type", "file"), t.setAttribute("accept", ".csv"), t.style.display = "none", t.onchange = function (t) {
        ...
        r.onload = function () {
            ...
            OrgChart._importSetColumnNames(e, function (t) {
                ...
                0 != OrgChart.events.publish("import", [h, o]) && (h.config.nodes = o.nodes, h.draw())
            })
    ...
    if (-1 == a.indexOf("id") || -1 == a.indexOf("pid")) {
        ...
        var C = document.createElement("LABEL"), m = document.createTextNode("Reports to:");
        C.setAttribute("for", "pid-select"), C.appendChild(m), C.style.fontSize = "16px", C.style.color = "rgb(122, 122, 122)", C.style.padding = "5px", C.style.margin = "5px", C.style.width = "30%", C.style.textAlign = "right", C.style.display = "inline-block", t.appendChild(C);
        var O = document.createElement("SELECT");
        O.id = "pid-select", O.style.fontSize = "16px", O.style.color = "rgb(122, 122, 122)", O.style.padding = "5px", O.style.margin = "5px", O.style.width = "60%", O.style.border = "1px solid #aeaeae", t.appendChild(O);
        ...
        x.innerHTML = "Import", x.style.fontSize = "16px", x.style.color = "rgb(122, 122, 122)", x.style.padding = "5px 20px", x.style.margin = "20px auto", x.style.display = "block", x.onclick = function () {
            ...
            a[e] = "id";
            var r = O.options[O.selectedIndex].value, i = a.indexOf(r);
            a[i] = "pid", n(a)
        };
        var v = document.createElement("DIV");
        return v.appendChild(x), t.appendChild(v), l.onclick = function (t) {
    ...
    this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide(), this.nodeCircleMenuUI.hide();
    var e = this.getNode(t), r = this.config.roots;
    if (r) {
        r.push(e.pid);
    ...
    for (var s = e.target; s != t;) {
        if (s.hasAttribute(OrgChart.attr.control_expcoll_id)) {
            var h = s.getAttribute(OrgChart.attr.control_expcoll_id), d = this.getNode(h);
        ...
        if (s.hasAttribute(OrgChart.attr.control_node_menu_id)) {
            ...
            h = s.getAttribute(OrgChart.attr.control_node_menu_id), d = this.getNode(h);
        ...
        if (s.hasAttribute(OrgChart.attr.control_node_circle_menu_name)) return e.stopPropagation(), e.preventDefault(), void this._nodeCircleMenuItemClickHandler(s, e);
        if (s.hasAttribute(OrgChart.attr.control_add)) return void this._lonelyButtonHandler();
        ...
        if (s.hasAttribute(OrgChart.attr.c_link_from)) return void OrgChart.events.publish("clink-click", [this, {
            from: s.getAttribute(OrgChart.attr.c_link_from),
            to: s.getAttribute(OrgChart.attr.c_link_to),
            event: e
        }]);
        if (s.hasAttribute(OrgChart.attr.s_link_from)) return void OrgChart.events.publish("slink-click", [this, {
...
},OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (O, t, r) {
    var e = O.parentNode.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id),
        y = O.getAttribute(OrgChart.attr.control_node_circle_menu_name), x = this.nodeCircleMenuUI._menu[y];
    if (x.draggable) {
        var v = this, i = OrgChart._getClientXY(t), a = this.getNode(e);
        O._dragEventFired = !1;
        var b = v.getScale(), _ = null, w = null;
        this._gragStartedId = e, document.body.style.mozUserSelect = document.body.style.webkitUserSelect = document.body.style.userSelect = "none";
        var k = this.getSvg(), S = {x: i.x, y: i.y}, I = O.cloneNode(!0);
        k.insertBefore(I, k.firstChild);
        var A = OrgChart._getTransform(I), E = A[4], M = A[5], N = function (t) {
        ...
        I.setAttribute("transform", "matrix(1,0,0,1," + (E + N.x) + "," + (M + N.y) + ")"), I.style.opacity = .7;
        var L = function (t, e) {
            if (null != t) {
                e.classList.remove("drag-over");
                for (var r = OrgChart.getStParentNodes(v.getNode(_)), i = 0; i < r.length; i++) {
            ...
            if (S) {
                var e = OrgChart._getClientXY(t), r = t.target;
                e.x += N.x * b, e.y += N.y * b;
                var i = OrgChart._getOffsetXY(v.element, t), a = {
                ...
                if (a.left || a.right || a.up || a.down) {
                    k.classList && (k.classList.remove("cursor-grab"), k.classList.add("cursor-move"), k.classList.remove("cursor-nodrop"), k.classList.remove("cursor-copy"));
                    var n = A[4], o = A[5], l = S.x, s = S.y, h = e.x, d = e.y;
                    v.startMove(a, function (t) {
                        A[4] = n + t.x, A[5] = o + t.y, S.x = l - t.xWithoutScale, S.y = s - t.yWithoutScale, e.x = h - t.xWithoutScale, e.y = d - t.yWithoutScale, I.setAttribute("transform", "matrix(" + A.toString() + ")")
                    })
                } else {
                    for (v.stopMove(), k.classList && (k.classList.add("cursor-grab"), k.classList.remove("cursor-move"), k.classList.remove("cursor-nodrop"), k.classList.remove("cursor-copy")), L(_, w), w = _ = null; null != r && r != k;) {
                    ...
                    if (null != _) {
                        ...
                        for (var g = v.getNode(_), p = OrgChart.getStParentNodes(g), f = 0; f < p.length; f++) {
                            var u = v.getNodeElement(p[f].id);
                            u && (u.style.opacity = .1)
                        }
                        k.classList.remove("cursor-grab"), k.classList.remove("cursor-move"), k.classList.add("cursor-copy"), k.classList.remove("cursor-nodrop")
                    }
                    var C = (e.x - S.x) / b, m = (e.y - S.y) / b;
                    if (A[4] = E + C, A[5] = M + m, !O._dragEventFired && (Math.abs(e.x - S.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(e.y - S.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === OrgChart.events.publish("drag", [v.nodeCircleMenuUI, {
                        from: c,
                        menuItem: x,
                        menuItemName: y
                    }]) && T(), O._dragEventFired = !0;
                    I.setAttribute("transform", "matrix(" + A.toString() + ")")
                }
            }
        }, T = function (t) {
            if (v.stopMove(), k.classList && (k.classList.remove("cursor-grab"), k.classList.remove("cursor-move"), k.classList.remove("cursor-nodrop"), k.classList.remove("cursor-copy")), k.removeEventListener(r.move, n), k.removeEventListener(r.up, T), r.leave && k.removeEventListener(r.leave, T), a.id == _ || null == _) return k.removeChild(I), v._gragStartedId = null, void (O._dragEventFired && OrgChart.events.publish("drop", [v.nodeCircleMenuUI, {
                from: a.id,
                menuItemName: y,
                menuItem: x
            }]));
            var e = v.getNode(_);
            OrgChart.events.publish("drop", [v.nodeCircleMenuUI, {
                from: a.id,
                to: e.id,
                menuItem: x,
                menuItemName: y
            }]), L(_, w), k.removeChild(I), v._gragStartedId = null
        };
        k.addEventListener(r.move, n), k.addEventListener(r.up, T), r.leave && k.addEventListener(r.leave, T)
    }
},OrgChart.prototype._nodeMouseDownHandler = function (O, t, i) {
    if (this.config.enableDragDrop) {
        var e = OrgChart._getClientXY(t), r = O.getAttribute(OrgChart.attr.node_id), y = this.getNode(r);
        O._dragEventFired = !1;
        var x = null, v = null;
        ...
        var b = this, _ = this.getSvg(), w = {x: e.x, y: e.y}, k = OrgChart._getTransform(O), S = k[4], I = k[5],
            A = b.getScale(), E = O.cloneNode(!0);
        _.insertBefore(E, _.firstChild), E.style.opacity = .7;
        var M = function (t, e) {
            if (null != t) {
                e.classList.remove("drag-over");
            ...
            if (w) {
                var e = OrgChart._getClientXY(t), r = t.target, i = OrgChart._getOffsetXY(b.element, t), a = {
                ...
                if (a.left || a.right || a.up || a.down) {
                    _.classList && (_.classList.remove("cursor-grab"), _.classList.add("cursor-move"), _.classList.remove("cursor-nodrop"), _.classList.remove("cursor-copy"));
                    var n = k[4], o = k[5], l = w.x, s = w.y, h = e.x, d = e.y;
                    b.startMove(a, function (t) {
                        k[4] = n + t.x, k[5] = o + t.y, w.x = l - t.xWithoutScale, w.y = s - t.yWithoutScale, e.x = h - t.xWithoutScale, e.y = d - t.yWithoutScale, E.setAttribute("transform", "matrix(" + k.toString() + ")")
                    })
                } else {
                    if (b.stopMove(), _.classList && (_.classList.add("cursor-grab"), _.classList.remove("cursor-move"), _.classList.remove("cursor-nodrop"), _.classList.remove("cursor-copy")), M(x, v), v = x = null, b.config.enableDragDrop) for (; null != r && r != _;) {
                        if (r.hasAttribute && r.hasAttribute(OrgChart.attr.node_id)) {
                            var c = r.getAttribute(OrgChart.attr.node_id);
                    ...
                    if (null != x) {
                        ...
                        !b._canUpdateLink(y.id, x) && _.classList ? (_.classList.remove("cursor-grab"), _.classList.remove("cursor-move"), _.classList.remove("cursor-copy"), _.classList.add("cursor-nodrop")) : _.classList && (_.classList.remove("cursor-grab"), _.classList.remove("cursor-move"), _.classList.add("cursor-copy"), _.classList.remove("cursor-nodrop"))
                    }
                    var C = (e.x - w.x) / A, m = (e.y - w.y) / A;
                    if (k[4] = S + C, k[5] = I + m, !O._dragEventFired && (Math.abs(e.x - w.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(e.y - w.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === OrgChart.events.publish("drag", [b, c]) && N(), O._dragEventFired = !0;
                    E.setAttribute("transform", "matrix(" + k.toString() + ")")
                }
            }
        }, N = function (t) {
            if (b.stopMove(), _.classList && (_.classList.remove("cursor-grab"), _.classList.remove("cursor-move"), _.classList.remove("cursor-nodrop"), _.classList.remove("cursor-copy")), _.removeEventListener(i.move, a), _.removeEventListener(i.up, N), i.leave && _.removeEventListener(i.leave, N), y.id != x && null != x) {
                var e = b.getNode(x);
                if (!1 === OrgChart.events.publish("drop", [b, y.id, e.id])) return M(x, v), _.removeChild(E), void (b._gragStartedId = null);
        ...
        _.addEventListener(i.move, a), _.addEventListener(i.up, N), i.leave && _.addEventListener(i.leave, N)
    }
    ...
    var p = function (t) {
        ...
        "pan" == c.type && s.config.sticky ? setTimeout(function () {
            OrgChart._moveToBoundaryArea(t, s.getViewBox(), s.response.boundary, function () {
                s._draw(!0, OrgChart.action.pan)
            })
        }, 0) : "pan" != c.type || s.config.sticky || s._draw(!0, OrgChart.action.pan), c = null, n.style.display = "none", t.removeEventListener(r.move, p), t.removeEventListener(r.up, f), r.leave && t.removeEventListener(r.leave, f), r.touchstart && t.removeEventListener(r.touchstart, f)
    };
    ...
    var t = this.obj.element.querySelector("[" + OrgChart.attr.id + '="search"]');
    if (t) {
        var e = t.querySelector("[" + OrgChart.attr.id + '="cell-1"]'),
            r = this.obj.element.getElementsByTagName("input")[0],
            i = this.obj.element.querySelector("[" + OrgChart.attr.id + '="container"]');
    ...
    var e = this.obj.element.querySelector("[" + OrgChart.attr.id + '="search"]'),
    ...
    var e = this.obj.element.querySelector("[" + OrgChart.attr.id + '="search-icon"]'),
    ...
    for (l = 0; l < p.length; l++) p[l].addEventListener("click", function () {
        var t = OrgChart.events.publish("searchclick", [e.obj, this.getAttribute(OrgChart.attr.search_item_id)]);
        null != t && 1 != t || e.obj.center(this.getAttribute(OrgChart.attr.search_item_id))
    ...
    OrgChart.state._get(this.config.state, d, c, function (t) {
        m.state = t, m.action = p, m.actionParams = f, p != OrgChart.action.init || !m.state || f && f.method && "fit" == f.method ? (m.viewBox = g, m.vbIsInitializedFromState = !1) : (m.viewBox = m.state.vb, m.vbIsInitializedFromState = !0);
        var r = m.maxX, i = m.maxY, a = m.minX, n = m.minY, o = m.bordersByRootIdAndLevel, l = m.roots, s = m.nodes;
        if (h) {
            var e = OrgChart.manager._getResponse(d, c, m.visibleNodeIds, m.config, r, i, a, n, m.viewBox, l, m.action, m.actionParams, s, m.oldNodes, m.vbIsInitializedFromState);
    ...
    var o = this,
        e = OrgChart.manager._createNodes(o.config, o.layoutConfigs, o.action, o.actionParams, o.oldNodes, o.state);
    t(e);
    var l = e.nodes, s = e.roots, r = OrgChart.remote;
    null == r && (r = OrgChart.local), r._setPositions(s, o.layoutConfigs, function (t) {
        var e = OrgChart.manager._doNotChangePositionOfClickedNodeIfAny(s, l, o.action, o.actionParams, o.oldNodes, o.config.orientation);
        ...
        for (var r = {
            ...
            maxX: null,
            maxY: null
        }, i = {}, a = 0; a < s.length; a++) OrgChart.manager._setMinMaxXYAdjustifyIterate(s[a], s[a], r, 0, i, e, o.config.orientation);
        n({
            minX: r.minX,
            minY: r.minY,
            maxX: r.maxX,
    ...
    t.w = u && u.size ? u.size[0] : 0, t.h = u && u.size ? u.size[1] : 0, t.padding = u && u.padding ? u.padding : [0, 0, 0, 0], null != i && (t.level = i), r && (t.lcn = r);
    var C = OrgChart._getSubLevels(t.tags, o.tags);
    0 < C && (t.subLevels = C), -1 != t.tags.indexOf("assistant") && null != t.parent && (t.isAssistant = !0), OrgChart.events.publish("node-created", [t])
},OrgChart.manager._iterate = function (t, e, r, i, a, n, o, l, s, h, d, c, g, p, f, u) {
    if (OrgChart.manager._initNode(e, r, s, i, c, h, d, g, p, f, u), e.isAssistant && (n[e.pid] || (n[e.pid] = []), n[e.pid].push(e.id)), 0 < e.subLevels && o.push(e.id), OrgChart.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !e.isAssistant && e.parent) {
        if (e.parent && e.parent.children.length && e.parent.children[e.parent.children.length - 1] == e) {
            for (var C = [], m = 0, O = 0, y = 0; y < e.parent.children.length; y++) {
                -1 == (x = e.parent.children[y]).tags.indexOf("partner") && -1 == x.tags.indexOf("left-partner") && -1 == x.tags.indexOf("right-partner") && -1 == x.tags.indexOf("assistant") && 0 == x.children.length ? C.push(x.id) : -1 != x.tags.indexOf("assistant") ? m++ : -1 == x.tags.indexOf("partner") && -1 == x.tags.indexOf("left-partner") && -1 == x.tags.indexOf("right-partner") || O++
            }
            OrgChart.MIXED_LAYOUT_ALL_NODES && 1 < C.length && C.length == e.parent.children.length - m - O ? l[e.pid] = C : !OrgChart.MIXED_LAYOUT_ALL_NODES && 1 < C.length && (l[e.pid] = C)
        }
    } else if (!e.isAssistant && 0 == e.childrenIds.length && e.parent && !l[e.pid]) {
        for (C = [], m = 0, O = 0, y = 0; y < e.parent.children.length; y++) {
            var x;
            -1 == (x = e.parent.children[y]).tags.indexOf("partner") && -1 == x.tags.indexOf("left-partner") && -1 == x.tags.indexOf("right-partner") && -1 == x.tags.indexOf("assistant") && 0 == x.childrenIds.length ? C.push(x.id) : -1 != x.tags.indexOf("assistant") ? m++ : -1 == x.tags.indexOf("partner") && -1 == x.tags.indexOf("left-partner") && -1 == x.tags.indexOf("right-partner") || O++
        }
    ...
    for (var v = 0; v < e.stChildren.length; v++) {
        var b = "";
        for (y = 0; y < e.tags.length; y++) if (h[e.tags[y]]) {
            b = e.tags[y];
            break
        }
        a.push(e.stChildren[v].id), OrgChart.manager._iterate(t, e.stChildren[v], r, 0, a, n, o, l, b, h, d, c, g, p, f, u)
    }
    i++;
    for (v = 0; v < e.children.length; v++) OrgChart.manager._iterate(t, e.children[v], r, i, a, n, o, l, s, h, d, c, g, p, f, u)
},OrgChart.manager.__createNodes = function (a, t, n, e, r, i) {
    for (var o = n.nodes, l = [], s = 0; s < o.length; s++) {
        var h, d = o[s];
        h = OrgChart.STRING_TAGS ? d.tags ? d.tags.split(",") : [] : Array.isArray(d.tags) ? d.tags.slice(0) : [];
        var c = OrgChart._getTemplate(h, n.tags, n.template), g = new OrgChart.node(d.id, d.pid, h, c);
        OrgChart.isNullOrEmpty(d.ppid) || (g.ppid = d.ppid), OrgChart.isNullOrEmpty(d.stpid) || (g.stpid = d.stpid), null != n.orderBy && (g.order = OrgChart.manager._getOrderFieldValue(d, n.orderBy)), a[d.id] = g, l.push(d.id)
    }
    null != n.orderBy && l.sort(function (t, e) {
        var r = a[t].order, i = a[e].order;
        return "number" == typeof r || "number" == typeof i ? (null == r && (r = -1), null == i && (i = -1), n.orderBy.desc ? i - r : r - i) : "string" == typeof r || "string" == typeof i ? (null == r && (r = ""), null == i && (i = ""), n.orderBy.desc ? i.localeCompare(r) : r.localeCompare(i)) : void 0
    });
    for (s = 0; s < l.length; s++) {
        var p = l[s], f = (g = a[p], i ? i[p] : null), u = a[g.stpid], C = a[g.pid];
        if (u || (g.stpid = null), C || (g.pid = null), u) {
            var m = i ? i[u.id] : null;
            m && (u.min = m.min), u.stChildrenIds.push(g.id)
        } else C ? (f && (g.collapsed = f.collapsed, g.min = f.min), C.childrenIds.push(g.id)) : (f && (g.collapsed = f.collapsed, g.min = f.min), t.push(g));
    ...
    if (OrgChart.manager.__createNodes(o, l, t, r, i, a), null != t.roots) {
        ...
        for (var s = 0; s < t.roots.length; s++) {
            ...
            if (h && r == OrgChart.action.centerNode) {
                for (var d = h; null != d.pid || null != d.stpid;) d = null == d.pid && null != d.stpid ? o[d.stpid] : o[d.pid];
                for (var c = o[i.id]; null != c.pid || null != c.stpid;) c = null == c.pid && null != c.stpid ? o[c.stpid] : o[c.pid];
                d == c && (h = d)
            }
            if (h) {
                for (var g = !1, p = 0; p < l.length; p++) if (l[p].id == h.id) {
                    g = !0;
                    break
                }
                if (!g) {
                    if (!OrgChart.isNullOrEmpty(h.pid)) -1 < (B = (K = o[h.pid]).childrenIds.indexOf(h.id)) && K.childrenIds.splice(B, 1);
                    l.push(h)
                }
            }
        }
    ...
    r == OrgChart.action.exporting && null != i.id && ((u = o[i.id]) && (u.pid = null, l = [u]));
    var f = [];
    if (r == OrgChart.action.init && t.expand && t.expand.nodes && null == n) for (s = 0; s < t.expand.nodes.length; s++) {
        var u = o[t.expand.nodes[s]];
        for (!0 === t.expand.allChildren && OrgChart.manager._addExpandedNodeIdsIterate(u, o, f); u;) f.push(u.id), null == u.pid && null != u.stpid ? (u = o[u.stpid]).min = !1 : u = o[u.pid]
    } else if (r == OrgChart.action.centerNode) {
        for (var C = o[i.id]; C;) {
            if (f.push(C.id), i.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && C) for (s = 0; s < C.childrenIds.length; s++) {
                (T = o[C.childrenIds[s]]).collapsed = !0
            }
            null == C.pid && null != C.stpid ? (C = o[C.stpid]).min = !1 : C = o[C.pid]
        }
        C = o[i.id];
        if (i.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS) for (s = 0; s < C.childrenIds.length; s++) {
            (O = o[C.childrenIds[s]]).collapsed = !1;
            for (var m = 0; m < O.childrenIds.length; m++) {
                o[O.childrenIds[m]].collapsed = !0
            }
        }
        if (i.options.parentState === OrgChart.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED) if (K = o[C.pid]) for (s = 0; s < K.childrenIds.length; s++) {
            var O;
    ...
    } else if (r == OrgChart.action.insert) for (u = o[i.insertedNodeId]; u;) f.push(u.id), null == u.pid && null != u.stpid ? (u = o[u.stpid]).min = !1 : u = o[u.pid];
    var y = [], x = {}, v = [], b = {}, _ = [];
    for (s = 0; s < l.length; s++) OrgChart.manager._iterate(l[s], l[s], o, 0, y, x, v, b, "", e, t, r, f, i, _, n);
    for (s = l.length - 1; 0 <= s; s--) l[s].collapsed && l.splice(s, 1);
    for (s = 0; s < _.length; s++) {
        u = o[_[s]];
        var w = [], k = [], S = [], I = {}, A = 0, E = 0, M = 0, N = [], L = [];
        for (m = 0; m < u.children.length; m++) {
            (T = u.children[m]).isAssistant ? w.push(T.id) : -1 != T.tags.indexOf("right-partner") ? (T.isPartner = 1, T.children = [], k.push(T.id)) : -1 != T.tags.indexOf("left-partner") ? (T.isPartner = 2, T.children = [], S.push(T.id)) : -1 == T.tags.indexOf("partner") || A % 2 ? -1 != T.tags.indexOf("partner") && A % 2 ? (T.isPartner = 2, T.children = [], S.push(T.id), A++) : T.parentPartner ? (I[T.parentPartner.id] || (I[T.parentPartner.id] = []), I[T.parentPartner.id].push(T.id)) : w.push(T.id) : (T.isPartner = 1, T.children = [], k.push(T.id), A++)
        }
        u.children = [];
        ...
        for (m = S.length - 1; 0 <= m; m--) if (I[S[m]]) for (p = 0; p < I[S[m]].length; p++) u.children.push(o[I[S[m]][p]]), E++, -1 == L.indexOf(S[m]) && L.push(S[m]);
        for (m = 0; m < w.length; m++) {
            var T = o[w[m]];
            u.children.push(T)
        }
        for (m = 0; m < k.length; m++) if (I[k[m]]) for (p = 0; p < I[k[m]].length; p++) u.children.push(o[I[k[m]][p]]), M++, -1 == N.indexOf(k[m]) && N.push(k[m]);
        u.partnerSeparation = Math.max(L.length, N.length) * t.partnerChildrenSplitSeparation + t.minPartnerSeparation, w.length || !E || M ? w.length || E || !M ? w.length || 1 != E || 1 != M ? w.length || E || M ? !w.length || E || M ? w.length && (E || M) ? u.hasPartners = 7 : u.hasPartners = 1 : u.hasPartners = 6 : u.hasPartners = 5 : u.hasPartners = 4 : u.hasPartners = 3 : u.hasPartners = 2
    }
    for (s = 0; s < v.length; s++) {
        if ((J = e[(u = o[v[s]]).lcn ? u.lcn : "base"]).layout == OrgChart.normal || !b[u.pid]) for (m = 0; m < u.subLevels; m++) {
            var B, P = new OrgChart.node(u.id + "_sub_level_index_" + m, u.pid, [], "subLevel");
            if (OrgChart.manager._initDinamicNode(P, u.lcn), K = u.parent) -1 < (B = K.children.indexOf(u)) && (K.children.splice(B, 1), K.children.splice(B, 0, P)), P.children.push(u), P.parent = K, o[(u.parent = P).id] = P
        }
    }
    for (var F in x) {
        (K = o[F]).hasAssistants = !0;
        P = new OrgChart.node(K.id + "_split_assitant_0", K.id, ["assistant"], "split");
        OrgChart.manager._initDinamicNode(P, K.lcn, !0), o[P.id] = P;
        var z = [];
        for (m = K.children.length - 1; 0 <= m; m--) {
            (T = K.children[m]).isAssistant ? (T.parent = null, K.children.splice(m, 1), z.splice(0, 0, T.id)) : T.isPartner || (T.parent && b[T.parent.id] && P && T.parent.id != P.id && (Object.defineProperty(b, P.id, Object.getOwnPropertyDescriptor(b, T.parent.id)), delete b[T.parent.id]), (T.parent = P).children.unshift(T), K.children.splice(m, 1))
        }
        if (z.length % 2) {
            var U = o[z[z.length - 1]], H = new OrgChart.node(U.id + "_mirror", U.pid, [], "mirror");
            OrgChart.manager._initDinamicNode(H, U.lcn, !0), U._m = H.id, H.isAssistant = !0, H.w = U.w, H.h = U.h, o[H.id] = H, z.splice(z.length - 1, 0, H.id)
        }
        var j = 1;
        for (m = z.length - 1; 0 <= m; m--) if (m % 2 && m != z.length - 1) {
            var R = new OrgChart.node(K.id + "_split_assitant_" + j, null, [], "split");
            OrgChart.manager._initDinamicNode(R, K.lcn, !0), o[R.id] = R, z.splice(m, 0, R.id), j++
        } else m % 2 && z.splice(m, 0, P.id);
        for (m = 0; m < z.length; m += 3) {
            var D = null;
            D = 0 == m ? K : o[z[m - 2]];
            var Y = o[z[m]], X = o[z[m + 1]], q = o[z[m + 2]];
            Y.parent = D, X.parent = D, (q.parent = D).children.push(Y), D.children.push(X), D.children.push(q)
        }
    }
    var V = !1;
    for (var W in e) {
        if ((J = e[W]).layout == OrgChart.mixed || J.layout == OrgChart.tree || J.layout == OrgChart.treeRightOffset || J.layout == OrgChart.treeLeftOffset) {
            V = !0;
            break
        }
    }
    if (V) {
        ...
        for (var F in b) {
            var K, J;
            if ((J = e[(K = o[F]).lcn ? K.lcn : "base"]).layout == OrgChart.mixed || J.layout == OrgChart.tree || J.layout == OrgChart.treeRightOffset || J.layout == OrgChart.treeLeftOffset) if (G.pnode = K, G.layout = J.layout, G.childrenIds = b[F], G.lastChildrenPidIds = b, OrgChart.events.publish("layout", [G]), G.layout == OrgChart.mixed) {
                var Z = G.childrenIds;
                for (s = Z.length - 1; 0 <= s; s--) {
                    K = (T = o[Z[s]]).parent, T.layout = OrgChart.mixed;
                    for (m = K.children.length - 1; 0 <= m; m--) if (T.id == K.children[m].id) {
            ...
            } else if (G.layout == OrgChart.tree || G.layout == OrgChart.treeRightOffset || G.layout == OrgChart.treeLeftOffset) {
                P = new OrgChart.node(K.id + "_split_0", K.id, [], "split");
                OrgChart.manager._initDinamicNode(P, K.lcn), (o[P.id] = P).layout = OrgChart.tree;
                var $ = [];
                for (s = G.childrenIds.length - 1; 0 <= s; s--) {
                    for (T = o[G.childrenIds[s]], m = 0; m < K.children.length; m++) K.children[m].id == T.id && K.children.splice(m, 1);
                    if (T.parent = null, T.layout = OrgChart.tree, G.layout == OrgChart.treeRightOffset && $.splice(0, 0, T.id), G.layout == OrgChart.treeLeftOffset || G.layout == OrgChart.treeRightOffset) {
                        var tt = new OrgChart.node(T.id + "_mirror", null, [], "mirror");
                        OrgChart.manager._initDinamicNode(tt, T.lcn), tt.layout = OrgChart.tree, o[tt.id] = tt, $.splice(0, 0, tt.id)
                    }
                    G.layout != OrgChart.treeRightOffset && $.splice(0, 0, T.id)
                }
                for (j = 1, m = $.length - 1; 0 <= m; m--) if (m % 2 && m != $.length - 1) {
                    R = new OrgChart.node(K.id + "_split_" + j, null, [], "split");
                    OrgChart.manager._initDinamicNode(R, K.lcn), R.layout = OrgChart.tree, o[R.id] = R, $.splice(m, 0, R.id), j++
                } else m % 2 && $.splice(m, 0, P.id);
                for (m = 0; m < $.length; m += 3) {
                    D = null;
                    0 == m && (D = K);
                    Y = o[$[m]], X = o[$[m + 1]], q = o[$[m + 2]];
                    0 != m && (D = o[$[m - 3]]), 0 == m || X || (D = o[$[m - 2]]), (Y.parent = D).children.push(Y), X && (0 != m && (D = o[$[m - 2]]), (X.parent = D).children.push(X)), q && (0 != m && (D = o[$[m - 1]]), (q.parent = D).children.push(q))
                }
            }
        }
    }
...
},OrgChart.manager._getResponse = function (t, e, r, i, a, n, o, l, s, h, d, c, g, p, f) {
    var u = h[0], C = [],
        m = {top: null, left: null, bottom: null, right: null, minX: null, maxX: null, minY: null, maxY: null},
        O = [[], [], []], y = a - o + 2 * i.padding, x = n - l + 2 * i.padding,
        v = OrgChart.getScale(s, t, e, i.scaleInitial, i.scaleMax, i.scaleMin, y, x);
    if (m.top = l - i.padding, m.left = o - i.padding, m.bottom = n + i.padding - e / v, m.right = a + i.padding - t / v, m.maxX = a, m.minX = o, m.maxY = n, m.minY = l, 0 == h.length || null == s && !f && i.align == OrgChart.CENTER) {
        var b = Math.ceil(t / v), _ = Math.ceil(e / v), w = 0, k = 0;
        if (b - 2 * i.padding >= a - o) switch (w = (a + o) / 2 - b / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                w = (o - a) / 2 - b / 2
        } else switch (w = u.x - b / 2 + OrgChart.manager._getNodeWidth(u, i) / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
        ...
        switch (i.orientation) {
            case OrgChart.orientation.top:
                w = u.x - b / 2 + OrgChart.manager._getNodeWidth(u, i) / 2, k = -i.padding;
                break;
            case OrgChart.orientation.bottom:
                w = u.x - b / 2 + OrgChart.manager._getNodeWidth(u, i) / 2, k = i.padding - _;
                break;
            case OrgChart.orientation.left:
                w = -i.padding, k = u.y - _ / 2 + OrgChart.manager._getNodeWidth(u, i) / 2;
                break;
            case OrgChart.orientation.right:
                w = i.padding - b, k = u.y - _ / 2 + OrgChart.manager._getNodeWidth(u, i) / 2;
                break;
            case OrgChart.orientation.top_left:
        ...
        s = [w, k, b, _], i.sticky && (s[0] < m.left && s[0] < m.right && (s[0] = m.left > m.right ? m.right : m.left), s[0] > m.right && s[0] > m.left && (s[0] = m.left > m.right ? m.left : m.right), s[1] < m.top && s[1] < m.bottom && (s[1] = m.top > m.bottom ? m.bottom : m.top), s[1] > m.bottom && s[1] > m.top && (s[1] = m.top > m.bottom ? m.top : m.bottom))
    }
    ...
    for (var E = 0; E < h.length; E++) OrgChart.manager._iterate2(h[E], g, i, s, d, c, C, p, r, O);
    return {
        animations: O,
        boundary: m,
        viewBox: s,
    ...
    if (OrgChart.manager._isVisible(t, r, i, a)) {
        ...
        if ((a == OrgChart.action.expand || a == OrgChart.action.collapse || a == OrgChart.action.maximize) && l && l[t.id] && "expandCollapseToLevel" == n.method) {
            ...
            var f, u;
            if ((!(f = l[t.id]) || OrgChart.isNullOrEmpty(f.x) && OrgChart.isNullOrEmpty(f.y)) && n) {
                if (u = e[n.id]) {
    ...
    exportMenuButton: '<div style="position:absolute;right:{p}px;top:{p}px; width:40px;height:50px;cursor:pointer;" ' + OrgChart.attr.control_export_menu + '=""><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"></div>',
    ...
    _defsIds: {}, defs: function (t) {
        ...
        for (var r in OrgChart.templates) {
            ...
            i.defs && (OrgChart.ui._defsIds[r] = OrgChart.randomId(), e += i.defs.replace("{randId}", OrgChart.ui._defsIds[r]))
        }
        ...
        for (var p in o) {
            var f, u = o[p];
            if (e && (f = e[u]), "function" == typeof u && (f = u(h, t, e)), g.value = f, g.element = d[p], g.name = u, !1 !== OrgChart.events.publish("field", [h, g])) if (null != g.value && null != g.value && null != g.element) c += (OrgChart._lblIsImg(i, p) || "string" != typeof g.value || (g.value = OrgChart.wrapText(g.value, g.element)), g.element.replace("{val}", function () {
                return g.value
        ...
        var C = OrgChart._getPosition(r, t, a, n), m = "node";
        Array.isArray(t.tags) && t.tags.length && (m += " " + t.tags.join(" ")), t.layout && (m += " tree-layout");
        var O = "";
        t.lcn && (O = 'lcn="' + t.lcn + '"');
        var y = OrgChart.nodeOpenTag.replace("{lcn}", O).replace("{id}", t.id).replace("{class}", m).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", C.x).replace("{y}", C.y),
            x = OrgChart._getOpacity(r, t);
        return c = (y = y.replace("{opacity}", x)) + (c += OrgChart.ui.nodeBtns(i, t, l, d, h)) + OrgChart.grCloseTag
    }, nodeBtns: function (t, e, r, i, a) {
        var n = "";
        return null == t.nodeMenu || e.isSplit || r === OrgChart.action.exporting || (n += i.nodeMenuButton.replace("{id}", e.id).replace("{cw}", e.w / 2).replace("{ew}", e.w - (e.padding ? e.padding[1] : 0))), null == t.nodeCircleMenu || e.isSplit || r === OrgChart.action.exporting || OrgChart.isNullOrEmpty(i.nodeCircleMenuButton) || (n += '<g style="cursor:pointer;" transform="matrix(1,0,0,1,' + i.nodeCircleMenuButton.x + "," + i.nodeCircleMenuButton.y + ')" ' + OrgChart.attr.control_node_circle_menu_id + '="' + e.id + '"><circle cx="0" cy="0" fill="' + i.nodeCircleMenuButton.color + '" r="' + i.nodeCircleMenuButton.radius + '" stroke-width="1" stroke="' + i.nodeCircleMenuButton.stroke + '"></circle><line x1="-' + i.nodeCircleMenuButton.radius / 2 + '" y1="-6" x2="' + i.nodeCircleMenuButton.radius / 2 + '" y2="-6" stroke-width="2" stroke="' + i.nodeCircleMenuButton.stroke + '"></line><line x1="-' + i.nodeCircleMenuButton.radius / 2 + '" y1="0" x2="' + i.nodeCircleMenuButton.radius / 2 + '" y2="0" stroke-width="2" stroke="' + i.nodeCircleMenuButton.stroke + '"></line><line x1="-' + i.nodeCircleMenuButton.radius / 2 + '" y1="6" x2="' + i.nodeCircleMenuButton.radius / 2 + '" y2="6" stroke-width="2" stroke="' + i.nodeCircleMenuButton.stroke + '"></line></g>'), n
        ...
        if (i !== OrgChart.action.exporting && !e.isSplit) {
            ...
            if (0 < e.childrenIds.length) {
                ...
                if (l -= h.expandCollapseSize / 2, s -= h.expandCollapseSize / 2, t.getCollapsedIds(e).length ? (n += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", l).replace("{y}", s), n += h.plus) : (n += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", l).replace("{y}", s), n += h.minus), (n += OrgChart.grCloseTag).indexOf("{collapsed-children-count}")) {
        ...
        var c = 0, g = OrgChart.getRootOf(t).id, p = i[g][t.sl], f = void 0;
        if (t.hasPartners) {
            f = {
                ids: [],
                indexes: {},
            ...
            for (var u = 0; u < t.children.length; u++) {
                (C = t.children[u]).parentPartner ? (f.ppnodes[C.id] = C.parentPartner, f.ids.push(C.id), 1 == C.parentPartner.isPartner ? (-1 == f.rightIds.indexOf(C.parentPartner.id) && f.rightIds.push(C.parentPartner.id), f.indexes[C.id] = f.rightIds.indexOf(C.parentPartner.id), f.firstRight || (f.firstRight = C)) : 2 == C.parentPartner.isPartner && (-1 == f.leftIds.indexOf(C.parentPartner.id) && f.leftIds.push(C.parentPartner.id), f.indexes[C.id] = f.leftIds.indexOf(C.parentPartner.id), f.lastLeft = C)) : C.isPartner || (f.lastLeft = C, f.firstRight || (f.firstRight = C))
            }
            f.maxSidePartnersWithChildren = Math.max(f.leftIds.length, f.rightIds.length), c = 0 == f.maxSidePartnersWithChildren ? e.config.minPartnerSeparation / 2 : e.config.minPartnerSeparation / 2 + f.partnerChildrenSplitSeparation * f.maxSidePartnersWithChildren + f.partnerChildrenSplitSeparation / 2
        }
        for (u = 0; u < t.children.length; u++) {
            var C = t.children[u], m = i[g][C.sl],
                O = {xa: 0, ya: 0, xb: 0, yb: 0, xc: 0, yc: 0, xd: 0, yd: 0, x: 0, y: 0, rotate: 0},
                y = (s = OrgChart.t(C.templateName, C.min, r)).link;
            if (f && -1 != f.ids.indexOf(C.id)) switch (l.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
            ...
            } else if ((C.isAssistant || 2 == C.layout) && C.rightNeighbor && C.rightNeighbor.isSplit) switch (l.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                ...
                case OrgChart.orientation.left_top:
                    O = OrgChart.ui._linkBottomToTop(C.rightNeighbor, C, s, d)
            } else if ((C.isAssistant || 2 == C.layout) && C.leftNeighbor && C.leftNeighbor.isSplit) switch (l.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                ...
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    if (1 == C.isPartner) O = OrgChart.ui._linkLeftToRight(t, C, s, c); else if (2 == C.isPartner) O = OrgChart.ui._linkRightToLeft(t, C, s, c); else {
                ...
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    if (1 == C.isPartner) O = OrgChart.ui._linkTopToBottom(t, C, s, c); else if (2 == C.isPartner) O = OrgChart.ui._linkBottomToTop(t, C, s, c); else {
            ...
            if (-1 != y.indexOf("{rounded}")) if (O.xa == O.xb && O.xa == O.xc && O.xa == O.xd || O.ya == O.yb && O.ya == O.yc && O.ya == O.yd) y = y.replace("{rounded}", "M" + O.xa + "," + O.ya + " L" + O.xd + "," + O.yd); else {
                var v = OrgChart.ui._roundedEdge(O.xa, O.ya, O.xb, O.yb, O.xc, O.yc),
                    b = OrgChart.ui._roundedEdge(O.xb, O.yb, O.xc, O.yc, O.xd, O.yd);
                y = y.replace("{rounded}", "M" + v.x1 + "," + v.y1 + " " + v.x2 + "," + v.y2 + " Q" + v.qx1 + "," + v.qy1 + " " + v.qx2 + "," + v.qy2 + " L" + b.x2 + "," + b.y2 + " Q" + b.qx1 + "," + b.qy1 + " " + b.qx2 + "," + b.qy2 + " L" + b.x3 + "," + b.y3)
            } else y = -1 != y.indexOf("{edge}") ? y.replace("{edge}", "M" + O.xa + "," + O.ya + " " + O.xb + "," + O.yb + " " + O.xc + "," + O.yc + " L" + O.xd + "," + O.yd) : -1 != y.indexOf("{curve}") ? y.replace("{curve}", "M" + O.xa + "," + O.ya + " C" + O.xb + "," + O.yb + " " + O.xc + "," + O.yc + " " + O.xd + "," + O.yd) : y.replaceAll("{xa}", O.xa).replaceAll("{ya}", O.ya).replaceAll("{xb}", O.xb).replaceAll("{yb}", O.yb).replaceAll("{xc}", O.xc).replaceAll("{yc}", O.yc).replaceAll("{xd}", O.xd).replaceAll("{yd}", O.yd);
            h.push(OrgChart.linkOpenTag.replace("{id}", t.id).replace("{class}", "link " + C.tags.join(" ")).replace("{child-id}", C.id));
            ...
            for (var k in e.config.linkBinding) {
                var S = e.config.linkBinding[k], I = e._get(C.id);
                if (I) {
                    var A = I[S];
                    _.value = A, _.element = s[k], _.name = S, !1 !== OrgChart.events.publish("label", [e, _]) && (OrgChart.isNullOrEmpty(_.value) || OrgChart.isNullOrEmpty(_.element) || (w += _.element.replace("{val}", _.value)))
                }
            }
            "" != w && (w = OrgChart.linkFieldsOpenTag.replace("{x}", O.x).replace("{y}", O.y).replace("{rotate}", 0) + w + OrgChart.grCloseTag, h.push(w)), h.push(OrgChart.grCloseTag)
        }
        return h.join("")
    }, svg: function (t, e, r, i, a, n) {
        return OrgChart.t(i.template, !1, n).svg.replace("{w}", t).replace("{h}", e).replace("{viewBox}", r).replace("{content}", function () {
            return a
        })
    ...
    c || (c = "ellipsis");
    var f = c.split("-");
    if (1 < f.length && (a = parseInt(c.split("-")[1]), 2 < f.length && "ellipsis" == f[2] && (n = !0)), !d) return t;
    if (d = parseFloat(d), l || (l = 0), s || (s = 0), l || (h = "start"), "ellipsis" == c) {
        p.removeChild(p.firstChild), p.textContent = t;
        for (var u = p.getComputedTextLength(), C = 2; d < u;) p.textContent = t.substring(0, t.length - C), p.textContent += "...", u = p.getComputedTextLength(), C++;
        return 2 < C ? "<title>" + t + "</title>" + p.textContent : t
    }
    if (-1 != c.indexOf("multiline")) {
        var m = t.split(" "), O = p.getBBox().height;
        p.textContent = "";
        var y = document.createElementNS(g, "tspan"), x = document.createTextNode(m[0]);
        y.setAttributeNS(null, "x", l), y.setAttributeNS(null, "y", s), y.setAttributeNS(null, "text-anchor", h), y.appendChild(x), p.appendChild(y);
        C = 1;
        for (var v = 1, b = 1; b < m.length; b++) {
            var _ = y.firstChild.data.length;
            if (y.firstChild.data += " " + m[b], y.getComputedTextLength() > d) {
                if (y.firstChild.data = y.firstChild.data.slice(0, _), v++, a && a < v) {
                ...
                (y = document.createElementNS(g, "tspan")).setAttributeNS(null, "x", l), y.setAttributeNS(null, "y", s + O * C), y.setAttributeNS(null, "text-anchor", h), x = document.createTextNode(m[b]), y.appendChild(x), p.appendChild(y), C++
            }
        }
        var k = "";
        if (null != p.innerHTML) k = p.innerHTML, p.innerHTML = ""; else {
            var S = "";
            for (b = p.childNodes.length - 1; 0 <= b; b--) S = XMLSerializer().serializeToString(p.childNodes[b]) + S, p.removeChild(p.childNodes[b]);
            k = S
        }
        return k
    }
    ...
    if (a[2] = this.width() / s, a[3] = this.height() / s, !0 === t && s < this.config.scaleMax || !1 === t && s > this.config.scaleMin || 0 != t && 1 != t && s < this.config.scaleMax && s > this.config.scaleMin) {
        this._hideBeforeAnimation();
        var h = this;
        r ? (clearTimeout(h._timeout), OrgChart.anim(this.getSvg(), {viewbox: this.getViewBox()}, {viewbox: a}, this.config.anim.duration, this.config.anim.func, function () {
    ...
    for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if (d && -1 != e.res.visibleNodeIds.indexOf(d.id) && (c && -1 != e.res.visibleNodeIds.indexOf(c.id))) {
            var g = d.x, p = d.y, f = c.x, u = c.y, C = {}, m = {}, O = g + d.w / 2, y = f + c.w / 2, x = p + d.h / 2,
                v = u + c.h / 2, b = 1;
            switch (this.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    O <= y ? (b = 1, C.x = O + d.w / 10, m.x = y - c.w / 10) : (b = -1, C.x = O - d.w / 10, m.x = y + c.w / 10), p == u ? (b = 1, C.y = p, m.y = u) : u < p ? (C.y = p, m.y = u + c.h) : (C.y = p + d.h, m.y = u);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    C.x = O <= y ? (b = -1, O + d.w / 10) : (b = 1, O - d.w / 10), m.x = y + c.w / 10, p == u ? (b = -1, C.y = p + d.h, m.y = u + c.h) : u < p ? (C.y = p, m.y = u + c.h) : (C.y = p + d.h, m.y = u);
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    C.y = x <= v ? (b = -1, x + d.h / 5) : (b = 1, x - d.h / 5), m.y = v + c.h / 5, g == f ? (b = -1, C.x = g, m.x = f) : f < g ? (C.x = g, m.x = f + c.w) : (C.x = g + d.w, m.x = f);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    C.y = x <= v ? (b = 1, x + d.h / 5) : (b = -1, x - d.h / 5), m.y = v + c.h / 5, g == f ? (b = 1, C.x = g + d.w, m.x = f + c.w) : f < g ? (C.x = g, m.x = f + c.w) : (C.x = g + d.w, m.x = f)
            }
            var _ = A(C, m, b), w = h.template;
            w || (w = "orange");
            var k = OrgChart.clinkTemplates[w],
                S = (r = C, a = _, void 0, n = ((i = m).x - r.x) / 2 + r.x, o = (i.y - r.y) / 2 + r.y, {
                    x: (n - a.x) / 2 + a.x,
                    y: (o - a.y) / 2 + a.y
                });
    ...
    var I = "", A = this.getScale(), E = t.res.boundary;
    ...
    function e(t, e, r) {
        ...
        var s = OrgChart.t(t.templateName, t.min, A), h = l.levelSeparation;
        ...
        if (t.level == e.level) switch (a = e, l.orientation) {
            ...
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                d.q = t.y + t.h, d.s = E.maxY - h, i.push([d.p, d.q]), i.push([d.r, t.y + t.h + h / 3]), s = OrgChart.t(a.templateName, a.min, A), i.push([a.x + a.w / 2 + s.expandCollapseSize, i[i.length - 1][1]]), i.push([i[i.length - 1][0], a.y + a.h]);
                break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
                d.p = t.x, d.q = t.y + t.h / 2 + s.expandCollapseSize, d.r = E.minX - h, d.s = t.y + t.h / 2 + s.expandCollapseSize, i.push([d.p, d.q]), i.push([t.x - h / 3, d.q]), s = OrgChart.t(a.templateName, a.min, A), i.push([i[i.length - 1][0], a.y + a.h / 2 + s.expandCollapseSize]), i.push([a.x, i[i.length - 1][1]]);
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                d.p = t.x + t.w, d.q = t.y + t.h / 2 + s.expandCollapseSize, d.r = E.maxX + h, d.s = t.y + t.h / 2 + s.expandCollapseSize, i.push([d.p, d.q]), i.push([t.x + t.w + h / 3, d.q]), s = OrgChart.t(a.templateName, a.min, A), i.push([i[i.length - 1][0], a.y + a.h / 2 + s.expandCollapseSize]), i.push([a.x + a.w, i[i.length - 1][1]])
        } else {
            switch (l.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
        ...
        var b = i.join(" ");
        if (M.label) {
            var _ = s.label.replace("{x}", y.x).replace("{y}", y.y).replace("{val}", M.label),
                w = OrgChart._getLabelSize(_), k = -w.height / 2;
            switch (l.orientation) {
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    k = w.height
            }
            I += s.label.replace("{x}", y.x).replace("{y}", y.y + k).replace("{val}", M.label)
        }
        I += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", t.id).replace("{to}", e.id) + s.link.replaceAll("{d}", b) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + b + '" />', I += OrgChart.grCloseTag
    }

    for (var r = 0; r < this.config.slinks.length; r++) {
        var M = this.config.slinks[r], i = S.getNode(M.from), a = S.getNode(M.to);
        i && a && -1 != t.res.visibleNodeIds.indexOf(a.id) && -1 != t.res.visibleNodeIds.indexOf(i.id) && (i.level >= a.level ? e(i, a, !1) : e(a, i, !0))
    }
    t.content += I
    ...
    t.config.enableKeyNavigation && (t._addEvent(window, "keydown", t._windowKeyDownHandler), OrgChart.isNullOrEmpty(t._keyNavigationActiveNodeId) && t.roots && t.roots.length && (t._keyNavigationActiveNodeId = t.roots[0].id, t.center(t._keyNavigationActiveNodeId)))
    ...
    if (!OrgChart.isNullOrEmpty(t._keyNavigationActiveNodeId) && ((r = t.getNodeElement(t._keyNavigationActiveNodeId)) && r.children.length)) {
        var i;
        (i = r.children[0]).setAttribute("tabindex", 2);
        var a, n = {text: "", id: t._keyNavigationActiveNodeId};
        if (OrgChart.events.publish("screen-reader-text", [t, n]), !OrgChart.isNullOrEmpty(n.text)) (a = document.createElementNS("http://www.w3.org/2000/svg", "title")).innerHTML = n.text, i.appendChild(a);
