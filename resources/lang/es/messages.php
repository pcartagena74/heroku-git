...
return [
    ...
    'flashes'                => [
        'merge_failure'    => 'es-The attempt to merge the records has failed.<br />:e',
        'password_success' => 'es-The password for the account with the login: :login was set successfully.',
    ],
    ...
    'event_types'            => [
        'Chapter Meeting'  => 'es-Chapter Meeting|Chapter Meetings',
        'Roundtable'       => 'es-Roundtable|Roundtables',
        'PD Day'           => 'es-PDC|PDCs',
        'Social Gathering' => 'es-Social Gathering|Social Gatherings',
        'Region Event'     => 'es-Region Event|Region Events',
        'Job Fair'         => 'es-Career Fair|Career Fairs',
        'Annual Meeting'   => 'es-Annual Meeting|Annual Meetings',
    ],

    'fields'                 => [

        'abstract'                   => 'es-Abstract',
        'aCost'                      => 'es-Additional Cost',
        'additional'                 => 'es-Additional Information',
        'add_det'                    => 'es-Additional Detail',
        'addr'                       => 'es-Address',
        'addr2'                      => 'es-Address Line #2',
