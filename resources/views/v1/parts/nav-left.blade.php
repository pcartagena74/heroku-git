    ...
    <div class="left_col scroll-view">
        ...
        <div class="profile">
            <div class="profile_pic">
                <img alt="{{ trans('messages.alt_txt.avatar') }}" class="img-circle profile_img" height="56"
                     src="{{ $currentPerson->avatarURL ?? '/images/user.png' }}" width="56"/>
            </div>
                        ...
                        <li><a> <i class="far fa-fw fa-user"></i> @lang('messages.nav.mbr_mgmt')
                            ...
                            <ul class="nav child_menu">
                                ...
                                <li><a href="{{ url('members')}}" id="mem"> @lang('messages.nav.m_list')
                                        <span class="label label-warning pull-right">@lang('messages.nav.b_slow')</span></a>
                                </li>
        ...
        <div class="sidebar-footer hidden-small">
            <a data-placement="top" data-toggle="tooltip"
               title="{{ trans('messages.nav.coming') }}: {{ trans('messages.nav.c_set') }}">
                <span aria-hidden="true" class="glyphicon glyphicon-cog">
                </span>
            </a>
            <a data-placement="top" data-toggle="tooltip"
               title="{{ trans('messages.nav.coming') }}: {{ trans('messages.nav.c_full') }}">
                <span aria-hidden="true" class="glyphicon glyphicon-fullscreen">
                </span>
            </a>
            <a data-placement="top" data-toggle="tooltip"
               title="{{ trans('messages.nav.coming') }}: {{ trans('messages.nav.c_lock') }}">
                <span aria-hidden="true" class="glyphicon glyphicon-eye-close">
                </span>
            </a>
            <a data-placement="top" data-toggle="tooltip" href="{{ url('/')}}/logout"
               title="{{ trans('messages.nav.c_log') }}">
