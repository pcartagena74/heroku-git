                    ...
                    <tr valign="middle">
                        <td style="text-align: center;">
                            <a target="_new" href="{{ $ics }}">
                                <img height="50" width="50" src="{{ str_replace('https','http',env('APP_URL')) }}/images/outlook.jpg">
                            </a>
                        </td>
                        <td style="text-align: center;">
                            <a target="_new" href="{{ $google_url }}">
                                <img height="50" width="50" src="{{ str_replace('https','http',env('APP_URL')) }}/images/google.jpg">
                            </a>
                        </td>
                        <td style="text-align: center;">
                            <a target="_new" href="{{ $yahoo_url }}">
                                <img height="50" width="50" src="{{ str_replace('https','http',env('APP_URL')) }}/images/yahoo.jpg">
                            </a>
                        </td>
                        <td style="text-align: center;">
                            <a target="_new" href="{{ $ics }}">
                                <img height="50" width="50" src="{{ str_replace('https','http',env('APP_URL')) }}/images/ical.jpg">
                            </a>
                        </td>
                    </tr>
                </table>
