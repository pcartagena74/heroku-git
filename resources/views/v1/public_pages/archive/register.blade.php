...
@section('content')
    ...
    @for($i=1; $i<=$quantity; $i++)
        ...
        <table id="ticket_head" class="table table-striped">
            <th colspan="3" style="text-align: left; vertical-align: middle;" class="col-md-6 col-sm-6 col-xs-12">
                <span id="ticket_type{{ $i }}">#{{ $i }} @if($isMember)
                        MEMBER
                    @else
                        NON-MEMBER
                    @endif
            ...
            <table class="table table-striped">
                ...
                <tr>
                    @if($event->hasFood)
                        ...
                        <th style="width:20%;"><b>List any special arrangements you may need.</b><br><small>We'll do our
                                best to accommodate you.</small></th>
                    @endif
                        ...
                        @if($i==1)
                            <td>
                                <div class="form-group col-md-12">
                                    ...
                                    <span class="far fa-wheelchair form-control-feedback left"
    ...
    <table class="table table-striped">
        <tr>
            ...
            <th style="text-align: left; vertical-align: top;"><i class="far fa-dollar"></i> <span
                        id="total">0.00</span>
                </td>
        </tr>
    </table>
