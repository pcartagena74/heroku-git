...
@if($event->ok_to_display() || $override)
    @section('content')
        ...
        {{ html()->form('POST', env('APP_URL') . '/regstep1/' . $event->eventID)->id('start_registration')->open() }}
                        ...
                        <div class="tab-pane active" id="tab_content1" aria-labelledby="ticketing-tab">
                            ...
                            @else
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            @foreach($bundles as $bundle)
                                                <tr>
                                                    ...
                                                    <td data-title="Ticket">
                                                        ...
                                                        @if($soldout)
                                                            <b class="red">This ticket is sold out. Add yourself to the
                                                                wait list.</b>
                                                        @endif
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="Ticket">{{ $ticket->ticketLabel }}
                                                        @if($ticket->maxAttendees > 0 && $ticket->regCount >= $ticket->maxAttendees)
                                                            <br/><b class="red">This ticket is sold out. Add yourself to
                                                                the wait
                                                                list.</b>
                                                        @endif
                                                    </td>
                                    ...
                                    &nbsp;<br/>
                                    <SUP style='color: red'>**</SUP>Bundles include multiple tickets so you do not have
                                    to
                                    ...
                                    <div class="tab-pane fade" id="tab_content2" aria-labelledby="sessions-tab">
                                        ...
                                        @if($event->confDays != 0)
                                            <div id="not" class="col-sm-12 col-md-12 col-xs-12">
                                                ...
                                                <p>Here are this event's {{ count($tracks) }} tracks and its sessions
                                                    from which attendees
                                                    can choose to participate.<br/>
                                                    This does not show any full-group keynotes, lunch or evening
                                                    sessions.</p>
                                                                    ...
                                                                    width: {{ $width }}%; max-width: {{ $mw }}%;">
                                                                                ...
                                                                                @if($s->sessionAbstract !== null)
                                                                                    <a tabindex="0"
                                                                                       ...
                                                                                       data-placement="left"
                                                                                       title="{!! $s->sessionName !!}"
                                                                                       data-content="{!! $s->sessionAbstract !!}">Abstract</a>
                                                                                    <br/>
                                                                                @endif
                                                                            </td>
                                                                        @else
                                                                ...
                                                                <tr>
                                                                    @foreach($tracks as $track)
                                                                        ...
                                                                        @if($s !== null && $s->sessionSpeakers !== null)
                                                                            <td data-title="Speaker" colspan="2"
                                                                                style="text-align:left;">
