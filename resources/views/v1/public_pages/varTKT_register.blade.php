...
?>
        ...
        <div class="col-sm-3">
            @if($event->hasFood)
                <div class="col-sm-12">
                    <label class="control-label" for="allergenInfo{{ $i_cnt }}">@lang('messages.fields.allergenInfo')<sup
                                class='red'>*</sup></label>
    ...
    <table class="table table-striped">
        <tr>
            ...
            <th style="text-align: left; vertical-align: top;">@lang('messages.symbols.cur') <span id="total">0.00</span></th>
        </tr>
    </table>
