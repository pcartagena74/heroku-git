...
<div class="container" style="padding-top: 20px;">
    ...
    <h4>Whether your organization holds events, or wants to measure member engagement,
    ...
    <div class="row">
        <div class="col-md-4 column_text">
            ...
            <p><a class="btn btn-default" href="/mktg" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-md-4 column_text">
            <h2>Mailings</h2>
            ...
            <p><a class="btn btn-default" href="/mail" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-md-4 column_text">
            <h2>Meetings</h2>
            ...
            <p><a class="btn btn-default" href="/mtgs" role="button">View details &raquo;</a></p>
        </div>
    </div>
</div>
@stop
