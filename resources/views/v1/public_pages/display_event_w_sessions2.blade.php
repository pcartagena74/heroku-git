                                    ...
                                    @if(count($bundles) + count($tickets) > 0)
                                        <div id="not" class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                            <table id="datatable" class="table table-striped jambo_table">
                                                ...
                                                <tr>
                                                    <th style="width: 40%"
                                                        colspan="2">@lang('messages.fields.ticket')</th>
                                                                ...
                                                                <tr>
                                                                    @foreach($tracks as $track)
                                                                        ...
                                                                        @if($s !== null)
                                                                            ...
                                                                            @endif
                                                                            <td data-title="{{ trans('messages.tabs.session') }}"
                                                                                colspan="2"
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                    <table class="table" style="border: none;">
                        <tr style="border: none;">
                            <td style="text-align: right; border: none;"><h4 class="red">@lang('messages.fields.from')
                                    :</h4>
                            </td>
