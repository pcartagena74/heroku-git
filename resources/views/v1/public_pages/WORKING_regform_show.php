...
<div class="col-md-12">
    <div style="text-align: left; vertical-align: middle;" class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div id="so-{{ $i }}" class="red" style="visibility: visible;"> &nbsp;
            &nbsp; {{ trans('messages.instructions.sold_out2') }}
        </div>
        @else
...
<div class="col-md-12">
    ...
    <div class="col-md-2 col-xs-6" style="text-align: right; vertical-align: middle;">
        <div id="da-{{ $i }}" style="visibility: {{ $ticket->waitlisting() ? " hidden
        " : "visible" }};">
...
<div class="col-sm-3 col-xs-12">
    ...
    <div class="col-xs-6">
        ...
        {!! Form::text("middleName$i_cnt", old("middleName$i_cnt"), array('class' => 'form-control input-sm', 'id' =>
        "middleName$i_cnt")) !!}
        <br/>
    ...
    <div class="col-xs-6">
        {!! Form::label("suffix$i_cnt", trans('messages.fields.suffix'), array('class' => 'control-label', 'for' =>
        'suffix_'.$i)) !!}
        {!! Form::text("suffix$i_cnt", old("suffix$i_cnt"), array('class' => 'form-control input-sm', 'id' =>
        "suffix$i_cnt")) !!}
        <br/>
    </div>
    ...
    <div class="col-xs-12">
        ...
        array('class' => 'form-control input-sm', 'size' => '3', 'multiple' => 'multiple', 'required', 'id' =>
        "certifications$i_cnt")) !!}
        @endif
    </div>
</div>
...
<div class="col-sm-3 col-xs-12">
    ...
    <div class="col-sm-12">
        ...
        {!! Form::text("compName$i_cnt", old("compName$i_cnt"), array('class' => 'form-control input-sm', 'id' =>
        "compName$i_cnt")) !!}
        <br/>

        {!! Form::label("title$i_cnt", trans('messages.fields.title'), array('class' => 'control-label')) !!}
        {!! Form::text("title$i_cnt", old("title$i_cnt"), array('class' => 'form-control input-sm', 'id' =>
        "title$i_cnt")) !!}
        <br/>
    </div>
    ...
    <div class="col-xs-12">
        ...
        !!}
        {!! Form::text("eventTopics$i_cnt", old("eventTopics$i_cnt"), array('class' => 'form-control input-sm', 'id' =>
        "eventTopics$i_cnt")) !!}
        <br/>

        {!! Form::label("cityState$i_cnt", trans('messages.fields.cityState'), array('class' => 'control-label')) !!}
        {!! Form::text("cityState$i_cnt", old("cityState$i_cnt"), array('class' => 'form-control input-sm', 'id' =>
        "cityState$i_cnt")) !!}
        <br/>
        ...
        <div class="container row col-sm-3">
            ...
            <div class="col-sm-2">{!! Form::checkbox("canNetwork$i_cnt", '1', false, array('class' => 'flat js-switch',
                'id' => "canNetwork$i_cnt", 'checked')) !!}
            </div>
...
<div class="col-sm-3 col-xs-12">
    ...
    @if($isMember)
    @include('v1.parts.tooltip', ['title' => trans('messages.tooltips.orgStat1_tip2', ['acs' =>
    strtolower($org->adminContactStatement)])])
    @else
    ...
    {!! Form::label("chapterRole$i_cnt", trans('messages.fields.chapterRole', ['org' => $org->orgName]), array('class'
    => 'control-label')) !!}
    {!! Form::text("chapterRole$i_cnt", old("chapterRole$i_cnt"), array('class' => 'form-control input-sm', 'id' =>
    "chapterRole$i_cnt")) !!}
    <br/>
    @endif
    ...
    <div class="container row col-xs-3">
        ...
        <div class="col-xs-2"> {!! Form::checkbox("isFirstEvent$i_cnt", '1', false, array('class' => 'flat js-switch',
            'id' => "isFirstEvent$i_cnt")) !!}
        </div>
    ...
    @else
    {{--
    {!! Form::label("isFirstEvent$i_cnt", trans('messages.fields.isFirstEvent', ['org' => $org->orgName]), array('class'
    => 'control-label')) !!}
    --}}
    @endif

    @if(!$should_skip)
    {!! Form::label("isAuthPDU$i_cnt", trans('messages.fields.isAuthPDU', ['org' => $org->orgName]), array('class' =>
    'control-label')) !!}
    <div class="container row col-sm-3">
        <div class="col-sm-1"><b>@lang('messages.yesno_check.no')</b></div>
        <div class="col-sm-2"> {!! Form::checkbox("isAuthPDU$i_cnt", '1', true, array('class' => 'flat js-switch', 'id'
            => "isAuthPDU$i_cnt")) !!}
        </div>
        <div class="col-sm-1"><b>@lang('messages.yesno_check.yes')</b></div>
    </div>
    ...
    !!}
    @endif
    {!! Form::textarea("eventQuestion$i_cnt", old("eventQuestion$i_cnt"), $attributes = array('class'=>'form-control
    input-sm', 'rows' => '2', 'id' => "eventQuestion$i_cnt")) !!}
    <br/>
    @endif
    <?php
...
<div class="col-sm-3 col-xs-12">
    ...
    array('required', 'class' => 'form-control input-sm', 'multiple' => 'multiple', 'size' => '3', 'id' =>
    "allergenInfo$i_cnt")) !!}
    <br/>

    {!! Form::label("eventNotes$i_cnt", trans('messages.fields.eventNotes'), array('class' => 'control-label')) !!}
    {!! Form::textarea("eventNotes$i_cnt", old("eventNotes$i_cnt"), $attributes = array('class'=>'form-control
    input-sm', 'rows' => '2', 'id' => "eventNotes$i_cnt")) !!}
    <br/>
    ...
    <div class="form-group has-feedback">
        {!! Form::text("specialNeeds$i_cnt", old("specialNeeds$i_cnt"), $attributes = array('class' => 'form-control
        has-feedback-left', 'id' => "specialNeeds$i_cnt")) !!}
...
<div class="col-md-12 panel panel-default">
    ...
    <div class="col-md-3 col-xs-12 form-group">
        {!! Form::number('additional'.$i_cnt, $orig_q-1, array('class' => 'form-control input-sm', 'id' =>
        'additional'.$i_cnt)) !!}
    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (def_tick.isDiscountExempt == 1) {
                    $("#discount_code").attr('placeholder', '{{ trans('
                    messages.reg_status.disc_exempt
                    ') }}'
                )
                    ;
    ...
    @endif
        ...
        function validateCode(eventID, which) {
            ...
            if (FieldIsEmpty(codeValue)) {
                var message = '<i class="fas fa-exclamation-triangle fa-2x text-warning mid_align">&nbsp;</i>@lang('
                messages.codes.empty
                ')';
        ...
        function change_tick(i, which) {
            ...
            if (t[0].isDiscountExempt == 1) {
                $("#discount_code" + which).attr('placeholder', '{{ trans('
                messages.reg_status.disc_exempt
                ') }}'
            )
                ;
