    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="tab-content" id="tab-content">
            <div aria-labelledby="ticketing-tab" class="tab-pane active" id="tab_content1">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td data-title="{{ trans('messages.fields.quantity') }}" style="text-align: left;">
                                        <div class="form-group">
                                            <input data-error="{{ trans('messages.errors.numeric') }}" id="q-{{ $bundle->ticketID }}" name="q-{{ $bundle->ticketID }}" pattern="[0-5]" required="" size="2" style="width:30px" type="number" value="0">
                                    ...
                                    <td data-title="{{ trans('messages.fields.ticket') }}">
                                        ...
                                        @if($soldout)
                                        <b class="red">
                                            @lang('messages.instructions.sold_out')
                                        </b>
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    <td data-title="{{ trans('messages.fields.quantity') }}" style="text-align: left; width:15px;">
                                        <div class="form-group">
                                            <input data-error="{{ trans('messages.errors.numeric') }}" id="q-{{ $ticket->ticketID }}" name="q-{{ $ticket->ticketID }}" pattern="[0-5]" required="" size="2" style="width:30px" type="number" value="0">
                                                <div class="help-block with-errors">
                                                </div>
                                            </input>
                                        </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="col-md-9 col-sm-9 col-xs-9 form-group" style="text-align: right">
                            <input class="form-control input-sm" id="discount_code" name="discount_code" placeholder="  {{ trans('messages.codes.empty') }}" type="text"/>
                        </div>
                ...
                @if($event->hasTracks)
                <div aria-labelledby="sessions-tab" class="tab-pane fade hidden-xs" id="tab_content2">
                    <br/>
                    @if($event->confDays != 0)
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    eventID]
                                                        ...
                                                        ?>
                                    <th colspan="{{ $columns }}" style="text-align:center; color: yellow; background-color: #2a3f54;">
                                ...
                                <tr>
                                    ...
                                    trackID],
                                                                    ...
                                                                    @if($s !== null)
                                                                        @if($tracks->first() == $track || !$event->isSymmetric)
                                    <td data-title="{{ trans('messages.fields.times') }}" rowspan="{{ $count>0 ? $count*3 : 3 }}" style="text-align:left;{{ $x%2?:'background-color:lightgray;' }}">
                                        <nobr>
                                    ...
                                    @endif
                                    <td colspan="2" data-title="{{ trans('messages.fields.session') }}" style="text-align:left; min-width:150px; width: {{ $width }}%; max-width: {{ $mw }}%;{{ $x%2?:'background-color:lightgray;' }}">
                                        <b>
                                            {{ $s->sessionName }}
                                        </b>
                                        @if($s->sessionAbstract !== null)
                                        <a class="btn btn-xs btn-primary pull-right" data-content="{!! $s->sessionAbstract !!}" data-html="true" data-placement="left" data-toggle="popover" data-trigger="focus" tabindex="0" title="{!! $s->sessionName !!}">
                                ...
                                <tr>
                                    ...
                                    trackID],
                                                                    ...
                                                                    ?>
                                                                    @if($s !== null)
                                    <td colspan="2" data-title="{{ trans('messages.fields.speakers') }}" style="text-align:left;{{ $x%2?'':'background-color:lightgray;' }}">
                                        <b>
                                ...
                                <tr>
                                    ...
                                    <td data-title="{{ trans('messages.fields.credit') }}" rowspan="{{ $count>0 ? ($count-1)*3+1 : 1 }}" style="text-align:left;{{ $x%2?:'background-color:lightgray;' }}">
                                        @if($s->leadAmt > 0)
                                        <b>
                                            {{ $s->leadAmt }}
                                    ...
                                    <td data-title="{{ trans('messages.fields.limit') }}" rowspan="{{ $count>0 ? ($count-1)*3+1 : 1 }}" style="text-align:left;{{ $x%2?:'background-color:lightgray;' }}">
                                        <b>
