            ...
            <div class="tab-content">
                <div id="privacy" class="tab-pane fade in active">
                    ...
                    <ol>
                        ...
                        <br/>
                        <ul>
                            <li><b>Client:</b> mCentric clients are the chapters, associations, or other organizations
                                who
                        ...
                        <li><b>Privacy Policy</b>
                            <br/>
                            mCentric is committed to protecting private information of all users of the site. mCentric
                            has no
                            intention to sell, rent or otherwise provide any user's personal information to any third
                            party
                        ...
                        <li><b>User Information Collection</b><br/>
                            ...
                            their users' interaction with our site. mCentric may collect and/or facilitate the
                            collection,
                        ...
                        <li><b>Disclosure of Personal Information</b><br/>
                            mCentric facilitates the sending of billing information to our third party payment
                            processor,
                            Stripe.com. No other information is disclosed to any other party for any reason, except
                            where
                        ...
                        <li><b>Use of Cookies</b><br/>
                            ...
                            Cookies do not run programs or viruses. mCentric does not use cookies to store sensitive
                            data.
                        </li>
                        <br/>

                        <li><b>Security of Personal Data</b><br/>
                            mCentric uses Secured Socket Layer (SSL) technology to provide you with the safest, most
                            secure
                            purchase experience possible.
                            SSL technology enables encryption of sensitive information, including passwords and credit
                            card
                            numbers, during online transactions.
                            <p></p>
                            Passwords are encrypted before getting stored in our database and the hardware and software
                            that
                        ...
                        <li><b>Links to Third Party Sites</b><br/>
                            ...
                            These sites are not under the control nor maintained by mCentric. Such links do not
                            constitute
                            an endorsement by mCentric of those other sites, the content displayed therein, or the
                            persons
                            or entities associated therewith. You acknowledge that mCentric is providing these links to
                            you
                            only as a convenience, and you agree that mCentric is not responsible for the content of
                            such
                        ...
                        <li><b>Acceptance</b><br/>
                            Use of mCentric.org signifies your acceptance to this privacy notice. If you do not agree,
                            do
                            not use this site.
                    ...
                    <ol>
                        <li><b>mCentric Client Services</b><br/>
                            ...
                            Fees associated with processed transactions are not refundable.<p>
                                Clients that wish to terminate the use of mCentric's services may do so with 30 days
                                notice in writing via the
                                mCentric support interface or email.
                        </li>
                        <br/>

                        <li><b>mCentric Client Event Registrations</b>
                            mCentric will honor the refund policy for individual event refunds based on the refund
                            policy
                            set forth by the client. The client continues to be responsible for any fees associated with
                            canceled registrations.
                        </li>
                        <li><b>Customers of mCentric Clients</b>
                            <ul>
                                <li>
                                    Requests for refunds of tickets purchased for events hosted by mCentric clients must
                                    be presented directly to the mCentric client.
                                </li>
                                <li>
                                    mCentric honors the refund policies of its clients and refund requests processed by
                                    its
                                    clients on behalf of their customers.
                                </li>
                            </ul>
                        </li>
                        <br/>
                ...
                <div id="terms" class="tab-pane fade">
                    ...
                    <p>When you create an account with us, or when you use an account that was created on your behalf by
                        an
                    ...
                    <p>Our Service may contain links to third-party web sites or services that are not owned or
                        controlled by
                        mCentric.</p>
                    <p>mCentric has no control over, and assumes no responsibility for, the content, privacy policies,
                        or
                    ...
                    <p>These Terms shall be governed and construed in accordance with the laws of Massachusetts, United
                        States,
                    ...
                    <p>Our failure to enforce any right or provision of these Terms will not be considered a waiver of
                        ...
                        between us
                        regarding our Service, and supersede and replace any prior agreements we might have between us
                        regarding
                        the Service.</p>
