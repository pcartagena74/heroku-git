...
<noscript>
    <iframe height="0" src="http://www.googletagmanager.com/ns.html?id=GTM-K4MGRCX"
    ...
    <div class="container">
        <div class="col-md-4 col-sm-4 col-xs-12" style="vertical-align: top;">
            <a class="navbar-brand" href="{{ str_replace('https', 'http', env('APP_URL')) }}/">
                <img alt="m|Centric" src="{{ str_replace('https', 'http', env('APP_URL')) }}/images/mCentric_logo.png"
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="{{ $yahoo_url }}" target="_new">
                                                <span class="far fa-stack fa-lg fa-2x">
                                                    <h1 class="far fa-3x fa-square fa-stack-2x"
                            ...
                            <td style="text-align: center;">
                                <a href="{{ $ics }}" target="_new">
                                                <span class="far fa-stack fa-lg fa-2x">
                                                    <h2 class="fal fa-3x fa-calendar-alt fa-stack-2x"
                                                        style="color: red;">
                                                    </h2>
                                                    <h2 class="fa-stack-1x"
                                                        style="text-align: center; color: black; margin-top:1em;">
                                                        ICS
                                                    </h2>
                                                </span>
                                </a>
                    ...
                    <table class="table borderless">
                        <tr valign="middle">
                            <td style="text-align: center;">
                                <a href="{{ $ics }}" target="_new">
                                    <img height="50"
                                         src="{{ str_replace('https', 'http', env('APP_URL')) }}/images/outlook.jpg"
                                         width="50"/>
                                </a>
                            </td>
                            <td style="text-align: center;">
                                <a href="{{ $google_url }}" target="_new">
                                    <img height="50"
                                         src="{{ str_replace('https', 'http', env('APP_URL')) }}/images/google.jpg"
                                         width="50"/>
                                </a>
                            </td>
                            <td style="text-align: center;">
                                <a href="{{ $yahoo_url }}" target="_new">
                                    <img height="50"
                                         src="{{ str_replace('https', 'http', env('APP_URL')) }}/images/yahoo.jpg"
                                         width="50"/>
                                </a>
                            </td>
                            <td style="text-align: center;">
                                <a href="{{ $ics }}" target="_new">
                                    <img height="50"
                                         src="{{ str_replace('https', 'http', env('APP_URL')) }}/images/ical.jpg"
                                         width="50"/>
                                </a>
                            </td>
                        </tr>
        ...
        <div class="pull-right">
            @if(!Auth::check())
                <a href="{{ str_replace('https', 'http', env('APP_URL')) }}">
                    <img alt="mCentric"
                         src="{{ str_replace('https', 'http', env('APP_URL')) }}/images/mCentric_logo_blue.png"
                         style="height: 25px;"/>
                </a>
            @else
                <img alt="mCentric" hspace="50"
                     src="{{ str_replace('https', 'http', env('APP_URL')) }}/images/mCentric_logo_blue.png"
                     style="height: 25px;"/>
            @endif
        </div>
