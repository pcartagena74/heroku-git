...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="tab-content" id="tab-content">
            <div aria-labelledby="lists-tab" class="tab-pane {{ $emailList === null ? 'active':'fade'}}"
                 id="tab_content1">
                <br/>
            ...
            <div aria-labelledby="create-tab" class="tab-pane {{ $emailList != null ? 'active':'fade'}}"
                 id="tab_content2">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-group list-group-mine draggable-list list-group-scroll"
                                    id="include-list">
