                            ...
                            <tr class="even pointer campaign-panel-{{$c->campaignID}}">
                                <td class=" ">
                                    <a href="{!! url('campaign',[$c->campaignID,'edit']) !!}">
                                        <img class="img-thumbnail" height="70px"
                                             src="{{getEmailTemplateThumbnailURL($c)}}" width="70px"/>
                                    </a>
                                </td>
                                <td>
                                    {!! $c->title !!}
                                ...
                                <td class="last">
                                    @if($c->sendDate === null)
                                        <a class="btn btn-primary btn-sm"
                                           href="{!! url('campaign',[$c->campaignID,'edit']) !!}"
                                           title="@lang('messages.buttons.common_edit')">
                                    ...
                                    @else
                                        <a class="btn btn-primary btn-sm"
                                           href="{!! url('campaign',[$c->campaignID,'edit']) !!}"
                                           title="@lang('messages.buttons.common_view')">
                                            <i aria-hidden="true" class="fa fa-eye">
                                            </i>
                                        </a>
                                    @endif
                                    <a class="btn btn-success btn-sm"
                                       href="{!! url('campaign',[$c->campaignID,'copy']) !!}"
                                       title="@lang('messages.buttons.common_copy')">
                                        <i class="fa fa-copy">
                                        </i>
                                    </a>
                                    <a class="btn btn-danger btn-sm" href="javascript:void(0)"
                                       onclick="deleteCampaign('{{$c->title}}','{{$c->campaignID}}')"
                                       title="@lang('messages.buttons.common_delete')">
                                        <i class="fa fa-close">
                                        </i>
                                    </a>
                                    @if($c->sendDate !== null)
                                        <a class="btn btn-warning btn-sm" href="javascript:void(0)"
                                           onclick="archiveCampaign('{{$c->title}}','{{$c->campaignID}}')"
                                           title="@lang('messages.buttons.archive')">
...
@include('v1.modals.context_sensitive_issue')
    --}}
    <div aria-hidden="true" aria-labelledby="popup-confirm-campaign-delete" class="modal fade"
         id="popup-confirm-campaign-delete" role="dialog">
    ...
    <div aria-hidden="true" aria-labelledby="popup-campaign-delete-success" class="modal fade"
         id="popup-campaign-delete-success" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button aria-hidden="true" class="close" data-dismiss="modal" type="button">
