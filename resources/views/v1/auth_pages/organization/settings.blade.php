...
@if((Entrust::can('settings-management'))
    ...
    @section('content')
        ...
        <table id="demographics" class="table table-striped table-condensed">
            ...
            <tr>
                <td colspan="2" style="text-align: left;"><a href="#" id="orgEmail"
                                                             data-value="{{ $org->orgEmail }}"></a>
                </td>
                <td style="text-align: left;"><a href="#" id="orgPhone" data-value="{{ $org->orgPhone }}"></a></td>
                <td colspan="2" style="text-align: left;"><a href="#" id="orgFax" data-value="{{ $org->orgFax }}"></a>
                </td>
            </tr>
            <tr>
                <th colspan="2"
            ...
            <tr>
                <td colspan="2" style="text-align: left;"><a href="#" id="orgURL" data-value="{{ $org->orgURL }}"></a>
                </td>
                <td colspan="1" style="text-align: left;"><a href="#" id="creditLabel"
                                                             data-value="{{ $org->creditLabel }}"></a></td>
                <td colspan="2" style="text-align: left;"><a href="#" id="orgHandle"
                                                             data-value="{{ $org->orgHandle }}"></a>
                </td>
            </tr>
            <tr>
