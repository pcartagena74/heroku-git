...
foreach($regs as $r){
    ...
    array_push($reg_rows, [$p->firstName, $p->lastName, $t->ticketLabel, $t->createDate->format('n/j/Y'), $f->confirmation, '<i class="fa fa-dollar"></i>'.$f->cost]);
}
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div id="tab-content" class="tab-content">
            <div class="tab-pane active" id="tab_content1" aria-labelledby="attendees-tab">
                ...
                @include('v1.parts.datatable', ['headers' => $reg_headers, 'data' => $reg_rows, 'scroll' => $reg_scroll])
