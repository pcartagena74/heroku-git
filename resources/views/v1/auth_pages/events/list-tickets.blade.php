...
@section('content')
    ...
    <div class="col-sm-8 col-md-8 col-xs-12">
        <table class="table table-bordered table-striped table-condensed">
            <tr>
                ...
                <th style="text-align: left;">@lang('messages.headers.waitList')</th>
            ...
            <tr>
                ...
                <td style="text-align: left;"><a id="earlyDiscount" data-value="{{ $event->earlyDiscount }}"
                                                 data-url="{{ env('APP_URL') }}/eventajax/{{ $event->eventID }}"
                                                 data-pk="{{ $event->eventID }}"></a></td>
                <td style="text-align: left;"><a id="isPrivate" data-value="{{ $event->isPrivate }}"
                                                 data-url="{{ env('APP_URL') }}/eventajax/{{ $event->eventID }}"
                                                 data-pk="{{ $event->isPrivate }}"></a></td>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12" style="text-align: left;">
        @if($event->hasTracks > 0)
            <a href="{{ env('APP_URL') }}/tracks/{{ $event->eventID }}"
               class="btn btn-default btn-primary">@lang('messages.buttons.t&s_edit')</a>
        @endif
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                                    ...
                                    <td class="col-md-4 col-md-offset-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"
                                                  id="basic_dollar{{ $n }}">@lang('messages.symbols.cur')</span>
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"
                                                  id="basic_dollar{{ $n }}2">@lang('messages.symbols.cur')</span><input
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="tkt_submit"
                            class="btn btn-sm btn-success">{{ trans_choice('messages.buttons.save_tkt', 1) }}</button>
                    </form>
                </div>
