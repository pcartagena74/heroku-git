...
@section('content')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block"
                              style="color: red;">@lang('ticketit::admin.config-edit-eval-warning') <code>eval('$value = serialize(' . $value . ');')</code></span>
                    </div>
                </div>
    ...
    @if($should_serialize)
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/{{ Kordy\Ticketit\Helpers\Cdn::CodeMirror }}/mode/clike/clike.min.js"/>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/{{ Kordy\Ticketit\Helpers\Cdn::CodeMirror }}/mode/php/php.min.js"/>
