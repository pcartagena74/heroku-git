 ...
 * Generated for Laravel 5.8.22 on 2020-05-06 04:48:01.
 *
...
namespace Collective\Html { 
    ...
    class FormFacade {
         ...
         * @static 
         */ 
        public static function custom($type, $name, $value = '#000000', $options = [])
        {
                        return \Collective\Html\FormBuilder::custom($type, $name, $value, $options);
        }
